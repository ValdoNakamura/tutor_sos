...
const Card = () => {
    return (
        <>
            <Link to="requestinfo" className="max-w-162 p-5 bg-[#EAD196] border border-gray-200 rounded-lg shadow-sm ">
                <div className="flex relative justify-between pt-7">
                    ...
                    <div>
                        ...
                        <h2 className=" text-2xl font-bold tracking-tight text-gray-900"> Para: Naruto Uzumaki</h2>
                    </div>
                ...
                <a className="inline-flex items-center mt-10 px-3 py-2 text-sm font-medium text-center text-white bg-[#561C24] rounded-lg focus:ring-4 focus:outline-none focus:ring-blue-300">
                    Read more
                </a>
            </Link>
        </>
